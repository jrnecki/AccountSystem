...
public enum ErrorCode {
    ...
    BANK_NOT_FOUND("은행이 없습니다."),
    ACCOUNT_ALREADY_EXISTS("이미 있는 계좌입니다."),
    ...
    CANCEL_MUST_FULLY("부분 취소는 사용되지 않습니다."),
    ...
    BALANCE_NOT_EMPTY("잔액이 없는 계좌는 해지할 수 없습니다."),
    MAX_COUNT_PER_USER("사용자 최대 계좌는 10개입니다.");
